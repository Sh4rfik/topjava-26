...
public class MealTestData {
    ...
    public static final Meal meal4 = new Meal(USER_MEAL_ID + 3, of(2015, Month.MAY, 31, 00, 0), "Еда на ограниченное время", 100);
    ...
    public static final Meal adminMeal1 = new Meal(ADMIN_MEAL_ID, of(2015, Month.JUNE, 21, 14, 0), "Админ ланч", 510);
    public static final Meal adminMeal2 = new Meal(ADMIN_MEAL_ID + 1, of(2015, Month.JUNE, 21, 21, 0), "Админ ужин", 1500);
